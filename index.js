...
*/
console.log('tast 1b', createMenuItem('pizza', 5, 'lunch'));
...
*/
reviews.push({name: "Kale", rating: 3, feedback: "The burgers were pretty good, but a little pricey, and the atmosphere wasn’t quite my taste."});
